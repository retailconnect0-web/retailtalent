...
export default function ReviewsPage() {
  ...
  const reviewCount = 12; // Mock for now

  const reviews = [
    { id: 1, author: "Rahul Desai", company: "Puma Store", rating: 5, date: "Oct 25, 2024", text: "Excellent promoter. Arrived on time and managed the weekend rush perfectly. Highly recommended for busy events." },
    { id: 2, author: "Neha Sharma", company: "Reliance Smart", rating: 5, date: "Oct 19, 2024", text: "Great merchandising skills. Made sure our FMCG aisle was fully stocked and visually appealing according to brand guidelines." },
    { id: 3, author: "Amit Singh", company: "L'Oreal Cosmetics", rating: 4, date: "Oct 06, 2024", text: "Good communication skills during the sampling drive. Customers responded well to the pitch." },
  ];
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-8">
        ...
        <div className="md:col-span-4">
          <div className="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm text-center">
            ...
            <div className="text-6xl font-black text-slate-900 mb-4">{rating.toFixed(1)}</div>
            <div className="flex justify-center items-center gap-1 mb-2">
              {[1, 2, 3, 4, 5].map((star) => (
                <Star key={star} className={`w-6 h-6 ${star <= Math.round(rating) ? 'fill-amber-400 text-amber-400' : 'fill-slate-100 text-slate-200'}`} />
              ))}
            </div>
        ...
        <div className="md:col-span-8">
          <div className="bg-white border border-slate-200 rounded-2xl p-6 md:p-8 shadow-sm h-full">
            ...
            <div className="space-y-4">
              {[
                { stars: 5, pct: 85, count: 10 },
                { stars: 4, pct: 15, count: 2 },
